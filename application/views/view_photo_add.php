	...
	<div class="container">
		<div id="body">			
			...
			<h1>Add a New Photo</h1>
				<form enctype="multipart/form-data" id="form1" name="form1" method="post" action="<?php echo base_url(); ?>index.php/photo/save_new_photo">
					<div>
						<input required type="text" name="txtPhotoname" id="txtPhotoname" placeholder="Add a Photo Title"/>
					</div>
					<div>
					...
					<div>
						<textarea rows="10" name="txtDescription" id="txtDescription" placeholder="Add a Description"></textarea>
					</div>
					<div>
